package confidentialstorage.client.console

import confidentialstorage.client.clientmodels.SessionManager.Session
import confidentialstorage.client.clientmodels.SessionManager.SessionEdv
import confidentialstorage.client.console.ConsoleInterfaceManager.boldColon
import confidentialstorage.client.console.ConsoleInterfaceManager.boldPrompt
import confidentialstorage.client.console.ConsoleInterfaceManager.boldString
import confidentialstorage.client.console.ConsoleInterfaceManager.errorColor
import confidentialstorage.client.console.ConsoleInterfaceManager.out
import confidentialstorage.client.console.ConsoleInterfaceManager.reader
...
object CommandLineInterface {
    ...
    fun start(args: Array<String>) {
        out(boldString("[Confidential Storage]"))
        out("Interactive CLI")
        out("Burgmann & Pavel & Zeiler")
